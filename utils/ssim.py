# ===============================================================
#
# Codes are obtained from https://github.com/VainF/pytorch-msssim
#
...
def ssim(X, Y, data_range=255, size_average=True, win_size=11,
...
def ms_ssim(X, Y, data_range=255, size_average=True, win_size=11,
...
class SSIM(torch.nn.Module):
    def __init__(self, data_range=255, size_average=True, win_size=11,
                 win_sigma=1.5, channel=3, K=(0.01, 0.03),
